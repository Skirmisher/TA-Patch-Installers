...
LangString no_patch ${LANG_ENGLISH} "The TA Unofficial Patch was not detected, is damaged, or is older than 3.9.3. In order to install ${MOD_NAME}, you must first install the patch and its associated resources. If you're not sure what this means, try downloading the $\"all-in-one$\" or $\"new player$\" installer from the mod's site (${WEBSITE})."
