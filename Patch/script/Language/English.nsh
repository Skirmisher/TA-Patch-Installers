...
LangString res_installer_ver ${LANG_ENGLISH} "That installer does not appear to contain the latest version of the TA Patch Resources, and may not work correctly with this installer. Are you sure you want to continue? (Selecting No will download the latest version for you.)"
